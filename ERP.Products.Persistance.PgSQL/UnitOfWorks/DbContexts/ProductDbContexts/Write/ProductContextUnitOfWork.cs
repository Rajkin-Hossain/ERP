...
namespace ERP.Products.Persistance.PgSQL.UnitOfWorks.DbContexts.ProductDbContexts.Write;
    ...
    private async Task AddTrackedDomainEvents(CancellationToken ct)
    {
        ...
        foreach (var entity in entities)
        {
            foreach (var domainEvent in entity.DomainEvents)
            {
                ...
                outboxBatch.Add(OutboxMessage.Create(entity.Id.Value, eventType, payload));
            }
        }
