...
public abstract class MongoReadRepository<T, TId>(DbContext dbContext) : IReadRepository<T, TId>
    where T : Entity<TId>
    where TId : notnull
{
        ...
        CancellationToken ct = default)
    {
        ...
        return AppPagedResult<T>.Create(items, pageNumber, pageSize, (int)totalCount);
    }
